...
const translations = {
  ...
  esCities: {
    ...
    'Vigo': '维戈',
    'Gijón': '希洪',
    'Hospitalet de Llobregat': '洛布雷加特河畔奥斯皮塔莱特',
    'Vitoria-Gasteiz': '维多利亚-加斯泰斯',
    'A Coruña': '拉科鲁尼亚',
    'Granada': '格拉纳达',
    'Elche': '埃尔切',
    ...
    'Móstoles': '莫斯托莱斯',
    'Pamplona': '潘普洛纳',
    'Santa Coloma de Gramenet': '圣科洛马-德格拉马内特',
    'Almería': '阿尔梅里亚',
    'Fuenlabrada': '富恩拉夫拉达',
    'Leganés': '莱加内斯',
    'Santander': '桑坦德',
    'Burgos': '布尔戈斯',
    'Castellón de la Plana': '卡斯特利翁',
    'Alcalá de Henares': '阿尔卡拉-德埃纳雷斯',
    'Getafe': '赫塔费',
    'Salamanca': '萨拉曼卡',
    'Huelva': '韦尔瓦',
    'Marbella': '马贝拉',
    ...
    'Mataró': '马塔罗',
    'Badajoz': '巴达霍斯',
    'Sant Cugat del Vallès': '圣库加特-德尔巴列斯',
    'Jaén': '哈恩',
    'Ourense': '奥伦塞',
    'Reus': '雷乌斯',
    'Telde': '特尔德',
    ...
    'Lorca': '洛尔卡',
    'Coslada': '科斯拉达',
    'Talavera de la Reina': '塔拉维拉-德拉雷纳',
    'El Ejido': '埃尔埃希多',
    'Torrevieja': '托雷维耶哈',
    'Torrejón de Ardoz': '托雷洪-德阿尔多斯',
    'Guecho': '格乔',
    'Getxo': '格乔',
    'Ceuta': '休达',
    'Melilla': '梅利利亚',
  ...
  itCities: {
    ...
    'Sassari': '萨萨里',
    'Latina': '拉蒂纳',
    'Giugliano in Campania': '坎帕尼亚朱利亚诺',
    'Monza': '蒙扎',
    'Syracuse': '锡拉库萨',
    'Siracusa': '锡拉库萨',
    'Bergamo': '贝加莫',
    ...
    'Treviso': '特雷维索',
    'Marsala': '马尔萨拉',
    'Busto Arsizio': '布斯托阿尔西齐奥',
    'Grosseto': '格罗塞托',
    'Pozzuoli': '波佐利',
    'Fiumicino': '菲乌米奇诺',
    'Guidonia Montecelio': '圭多尼亚-蒙泰切利奥',
    'Casoria': '卡索里亚',
    'Caserta': '卡塞塔',
    'Castellammare di Stabia': '斯塔比亚海堡',
    'Alessandria': '亚历山德里亚',
    'Ragusa': '拉古萨',
    'Caltanissetta': '卡尔塔尼塞塔',
    'Sesto San Giovanni': '塞斯托圣乔瓦尼',
    'Viterbo': '维泰博',
    'Catanzaro': '卡坦扎罗',
    'Lucca': '卢卡',
    'Aosta': '奥斯塔',
  ...
  mxCities: {
    ...
    'Naucalpan': '瑙卡尔潘',
    'Ecatepec': '埃卡特佩克',
    'Nezahualcóyotl': '内萨瓦尔科约特',
    'Gustavo A. Madero': '古斯塔沃·A·马德罗',
    'Álvaro Obregón': '阿尔瓦罗·奥夫雷贡',
    ...
    'Iztacalco': '伊斯塔卡尔科',
    'Magdalena Contreras': '马格达莱纳·孔特雷拉斯',
    'Milpa Alta': '米尔帕阿尔塔',
    'Tláhuac': '特拉瓦克',
    'Xochimilco': '索奇米尔科',
    'Tlalpan': '特拉尔潘',
    ...
    'Tecate': '特卡特',
    'La Paz': '拉巴斯',
    'Cabo San Lucas': '圣卢卡斯角',
    'San José del Cabo': '圣何塞-德尔卡沃',
    'Parral': '帕拉尔',
    'San Nicolás de los Garza': '圣尼古拉斯-德洛斯加萨',
    'Apodaca': '阿波达卡',
    'Guadalupe': '瓜达卢佩',
    'Santa Catarina': '圣卡塔琳娜',
    'San Pedro Garza García': '圣佩德罗-加萨加西亚',
    'Matamoros': '马塔莫罗斯',
    'Tampico': '坦皮科',
    'Gómez Palacio': '戈麦斯帕拉西奥',
    'Lerdo': '莱尔多',
    'Fresnillo': '弗雷斯尼略',
    'San Miguel de Allende': '阿连德圣米格尔',
    'Uruapan': '乌鲁阿潘',
    'Zitácuaro': '西塔夸罗',
    'Manzanillo': '曼萨尼约',
  },
...
// 获取德国城市中文名（增强版）
function getDECityTranslation(cityName) {
  return normalizeCityName(cityName, translations.deCities);
}

// 获取西班牙城市中文名（增强版）
function getESCityTranslation(cityName) {
  return normalizeCityName(cityName, translations.esCities);
}

// 获取意大利城市中文名（增强版）
function getITCityTranslation(cityName) {
  return normalizeCityName(cityName, translations.itCities);
}

// 获取墨西哥城市中文名（增强版）
function getMXCityTranslation(cityName) {
  return normalizeCityName(cityName, translations.mxCities);
}
...
function translateAddress(countryCode, regionName, level) {
  ...
  if (level === 'city' || level === 'City') {
    switch (country) {
      ...
      case 'de':
        return getDECityTranslation(regionName);
      case 'es':
        return getESCityTranslation(regionName);
      case 'it':
        return getITCityTranslation(regionName);
      case 'mx':
        return getMXCityTranslation(regionName);
      default:
        return regionName;
    }
  }
