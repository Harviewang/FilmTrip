...
| M-4 | 地图·地址解析 | 全球坐标→5级字段（country/province/city/district/township） | AI助手 | ✅ 已完成 | 统一使用MapTiler API，支持全球 |
...
### 实现要点
1. ✅ **移除高德和腾讯**：不支持全球
2. ✅ **统一MapTiler**：支持国内外所有地点
3. ✅ **适配MapTiler格式**：灵活解析country/province/city/district/township
4. ✅ **保持5级结构**：兼容不同国家的行政层级

### 测试结果
- **深圳**：country=中国, province=广东省, city=南山区, township=粤海街道 ✅
- **纽约**：country=United States, province=New York, district=Manhattan ✅
- **全球支持**：国内外所有坐标均可解析 ✅
