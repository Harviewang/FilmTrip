...
| P1-3 | 预览模式 | 依据原始尺寸/方向，设定标准预览与沉浸预览的默认尺寸与旋转表现 | AI助手 | 待完成 | 依赖 10-23 新增的 `width`/`height`/`orientation` 数据 |
| P1-4 | 预览模式 | 预览模式默认行为优化：列表点击照片默认打开标准预览模式 | AI助手 | 待完成 | ⭐ 新增：与P1-3关联，确保体验一致性 |
