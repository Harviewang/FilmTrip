...
- Rev-3（2025-11-10）：恢复 `/s/:shortCode` 指向 Gallery，新增后端 profile 校验辨别管理员权限，避免本地伪造绕过保护。

## 7. Git 提交
- commit message：
  1. `SL-1-MAP: unify short-link handling for timeline and preview`
  2. `fix(SL-1-MAP): resolve timeline short-link audit issues`
  3. `fix(SL-1-MAP): restore gallery short-link route and verify admin via API`
  4. `fix(SL-1-MAP): normalize profile payload for admin detection`
- commit hash：
  - f01e8daf3465b1ba100ca9d6bce7f560ce017963
  - 794eafe9e93890a5ccebb5f8afea1d3e6d7c0b45
  - e077d08d2b3e390b2aeb7891323b38e2e4d6d037
  - 5003b5d5bd6ad611300cbd44d90bd4489f500473
