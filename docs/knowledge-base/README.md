...
- `胶卷罐交互需求澄清记录.md` - 胶卷罐交互详细需求澄清 ⭐（⚠️ 目标方案，当前实现为2x3网格临时方案）
- `预览模式功能需求澄清记录-详细版.md` - 预览模式功能完整逻辑澄清 ⭐
- `随机交互需求澄清记录.md` - 用户需求澄清记录（⚠️ 目标方案，当前实现为2x3网格临时方案）
- `随机浏览功能需求澄清记录-详细版.md` - 详细需求澄清（⚠️ 目标方案，当前实现为2x3网格临时方案）
- `文档更新总结.md` - 文档维护的最佳实践
- `代码审查清单.md` - 代码审查规范
- `API设计规范.md` - API设计最佳实践
- `地图中文地点增强最佳实践-2025-10-28.md` - 地图选点解析与预览按需加载最佳实践
- `CDN与地图加速讨论纪要-2025-11-06.md` - CDN接入、水印、地图聚合等讨论方案 ⭐
...
**文件示例**：
- `film-stocks/README.md` - 胶卷素材归档流程
- `胶卷素材清单-2025-11-07.md` - 素材清单与缺失项记录
...
**当前文档数量**（含最新整理）：
- best-practices/: 11 个文档
- refactoring-guides/: 1 个文档
- problem-solving/: 4 个文档
- assets/: 2 个文档
...
- ✅ 合并 `docs/best-practices/` 孤立文档到 `knowledge-base/best-practices/`
- ✅ 新增 `assets/` 专区，集中管理胶卷素材与导入脚本配套说明
- ✅ 更新文档数量统计，保持索引准确
