...
| `frontend/src/pages/Gallery/index.jsx` | 平铺模式添加`object-center`居中裁切 | ✅ 完成 |
| `frontend/src/pages/Gallery/index.jsx` | 移除瀑布流中的`imageOrientation` | ✅ 完成 |
| `frontend/src/pages/Gallery/index.jsx` | 简化瀑布流span计算逻辑 | ✅ 完成 |
| `frontend/src/pages/Gallery/index.jsx` | 移除不再使用的`masonrySpans` state | ✅ 完成 |
